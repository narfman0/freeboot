				...
				new jbt.model.task.composite.ModelSelector(
						...
						new jbt.model.task.composite.ModelSequence(
								...
								new jbt.model.task.decorator.ModelLimit(
										null,
										1,
										new com.blastedstudios.freeboot.ai.bt.actions.ForestInit(
												null))),
						new jbt.model.task.composite.ModelSequence(
								null,
								new com.blastedstudios.freeboot.ai.bt.actions.Jump(
								...
								new jbt.model.task.composite.ModelParallel(
										...
										new jbt.model.task.composite.ModelSelector(
												...
												new jbt.model.task.composite.ModelSequence(
														...
														new jbt.model.task.leaf.ModelWait(
																null, 200),
														new com.blastedstudios.freeboot.ai.bt.conditions.PlayerUnder(
																null)))),
								new com.blastedstudios.freeboot.ai.bt.actions.Drop(
										null),
								new com.blastedstudios.freeboot.ai.bt.actions.Land(
										null),
								new com.blastedstudios.freeboot.ai.bt.actions.Action(
										null, "lunge", null),
								...
								new jbt.model.task.composite.ModelParallel(
										...
										new jbt.model.task.composite.ModelSequence(
												null,
												new com.blastedstudios.freeboot.ai.bt.actions.RunAway(
														null),
												new com.blastedstudios.freeboot.ai.bt.actions.CooldownEnd(
														null,
														"forestBossCooldown",
														null),
												new com.blastedstudios.freeboot.ai.bt.actions.Stop(
														null))))));
