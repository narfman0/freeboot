...
public class Alert extends jbt.execution.task.leaf.condition.ExecutionCondition {
	 ...
	 * com.blastedstudios.freeboot.ai.bt.conditions.Alert.
	 */
	public Alert(jbt.model.core.ModelTask modelTask,
		...
		if (!(modelTask instanceof com.blastedstudios.freeboot.ai.bt.conditions.Alert)) {
			throw new java.lang.RuntimeException(
					"The ModelTask must subclass com.blastedstudios.freeboot.ai.bt.conditions.Alert");
		}
	}
